...
using InventoryManagement.AccountModel;

namespace InventoryManagement.AccountUtils
{
    public static class AccountHelper
    {
        ...
        private static async void SaveAccountListAsync()
        {
            ...
            {
                StorageFile accountsFile = await ApplicationData.Current.LocalFolder.CreateFileAsync(USER_ACCOUNT_LIST_FILE_NAME, CreationCollisionOption.ReplaceExisting);
                await FileIO.WriteTextAsync(accountsFile, accountsXml);
            }
        }
